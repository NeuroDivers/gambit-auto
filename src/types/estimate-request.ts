...
export type EstimateRequestStatus = "pending" | "estimated" | "accepted" | "rejected" | "converted";
...
export type EstimateRequestFormData = {
  vehicleInfo: {
    make: string;
    model: string;
    year: number;
...
export type QuoteRequest = EstimateRequest
export type QuoteRequestStatus = EstimateRequestStatus
export type QuoteRequestFormData = EstimateRequestFormData
