  ...
  return (
    <div className="min-h-screen bg-[#121212] py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <div className="bg-[#1A1F2C]/80 backdrop-blur-lg rounded-xl border border-white/10 shadow-xl overflow-hidden transition-all duration-200 hover:border-[#9b87f5]/30">
