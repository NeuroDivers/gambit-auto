...
export function CalendarGridHeader({ visibleDays, onDateClick, blockedDates = [] }: CalendarGridHeaderProps) {
  ...
  return (
    <div className="grid grid-cols-[86px_repeat(30,64px)] bg-muted/50 rounded-t-lg sticky top-0 z-10">
      ...
      {visibleDays.map((day) => {
        ...
        return (
          <div 
            ...
            className={`flex flex-col items-center justify-center cursor-pointer hover:bg-accent/50 rounded ${
